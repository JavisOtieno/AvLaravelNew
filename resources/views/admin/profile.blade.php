...
@section('content') 
      ...
      <main id="main-container">
        <!-- Hero -->
        <div class="bg-image" style="background-image: url('{{asset('adminassets/media/photos/photo10@2x.jpg')}});">
          <div class="bg-primary-dark-op">
            <div class="content content-full text-center">
              <div class="my-3">
                <img class="img-avatar img-avatar-thumb" src="{{asset('adminassets/media/avatars/avatar13.jpg')}}" alt="">
              </div>
                ...
                <div class="row push">
                  ...
                  <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                      ...
                      <div class="mb-4">
                        <img class="img-avatar" src="{{asset('adminassets/media/avatars/avatar13.jpg')}}" alt="">
                      </div>
                      <div class="mb-4">
