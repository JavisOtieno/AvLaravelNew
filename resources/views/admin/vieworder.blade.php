        ...
        <div class="content content-boxed">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">View Order</h3>
            </div>
                ...
                <div class="row push">
                  ...
                  <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" readonly class="form-control" id="one-profile-edit-name" name="one-profile-edit-name" placeholder="Name" value="{{$order['customer']['name']}}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="one-profile-edit-email">Quantity</label>
                      <input type="text" readonly class="form-control" id="one-profile-edit-email" name="one-profile-edit-email" placeholder="Quantity" value="{{$order['quantity']}}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" readonly class="form-control" id="one-profile-edit-phone" name="one-profile-edit-phone" placeholder="Status" value="{{$order['created_at']}}">
                    </div>
