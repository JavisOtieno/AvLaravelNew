        ...
        <div class="content content-boxed">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">View Customer</h3>
            </div>
                ...
                <div class="row push">
                  <div class="col-lg-4">
                    {{-- <p class="fs-sm text-muted">
                        View the details of your customer below.
                    </p> --}}
                  </div>
                  <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                      <label class="form-label" for="one-profile-edit-name">Customer Name</label>
                      <input type="text" readonly class="form-control" id="one-profile-edit-name" name="one-profile-edit-name" placeholder="Name" value="{{$customer['name']}}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="one-profile-edit-email">Phone</label>
                      <input type="text" readonly class="form-control" id="one-profile-edit-email" name="one-profile-edit-email" placeholder="Phone" value="{{$customer['phone']}}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="one-profile-edit-phone">Date and Time</label>
                      <input type="text" readonly class="form-control" id="one-profile-edit-phone" name="one-profile-edit-phone" placeholder="Date" value="{{$customer['created_at']}}">
                    </div>
