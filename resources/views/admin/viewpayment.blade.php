                ...
                <div class="row push">
                  <div class="col-lg-4">
                    {{-- <p class="fs-sm text-muted">
                        View the details of your payment below.
                    </p> --}}
                  </div>
                  <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" readonly class="form-control" id="one-profile-edit-phone" name="one-profile-edit-phone" placeholder="Date" value="{{$payment['created_at']}}">
                    </div>
