            ...
            <div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb">
                        ...
                        <a href="product-category.html">{{$product['category']['title']}}</a>
                        <span class="delimiter"><i class="fa fa-angle-right"></i></span>
                                    ...
                                    <div class="summary entry-summary">
                                        ...
                                        <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                            ...
                                            {{-- <p class="price"><span class="electro-price"><ins><span class="amount">{{"KSh ".number_format($product['price'])}}</span></ins>
                                                 // <del><span class="amount">&#36;2,299.00</span></del> //commented out
                                                </span></p> --}}
                                                <p class="price">
                                                    <span class="electro-price">
                                                        @if($product['price'] > 0)
                                                            <ins>
                                                                <span class="amount">{{ "KSh ".number_format($product['price']) }}</span>
                                                            </ins>
                                                        @endif
