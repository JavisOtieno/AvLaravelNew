        ...
        <div class="row">
            ...
            <div class="header-logo">
                <a href="/" class="header-logo-link">
                    ...
                    <h1 style="color: #333E48;font-weight:900;">
                        <strong>{{ ucfirst(request()->get('user')['websitename']) }}</strong><span
                            style="color: #FED700">.</span></h1>
                </a>
            </div>
            <!-- ============================================================= Header Logo : End============================================================= -->
                    ...
                    <nav>
                        <ul id="menu-main-menu" class="nav nav-inline yamm">
                            ...
                            <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                <a title="Pages" href="#" data-toggle="dropdown" class="dropdown-toggle"
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <span class="support-number"><strong>Support</strong>
                            {{ request()->get('user')['phone'] }}</span><br />
    ...
    <div class="container">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                <li class="menu-item animate-dropdown menu-item-object-static_block">
                                    <div class="yamm-content">
                                        <div
                                            class="vc_row row wpb_row vc_row-fluid bg-yamm-content bg-yamm-content-bottom bg-yamm-content-right">
                                                            ...
                                                            <figure class="wpb_wrapper vc_figure">
                                                                <div
                                                                    ...
                                                                    <img width="540" height="460"
                                                                        src="/assets/images/megamenu-2.png"
                                                        ...
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="/category/{{ $category['name'] }}">All
                                                                            {{ $category['title'] }}</a></li>
                                                                    ...
                                                                    @if ($category->children->isNotEmpty())
                                                                        @foreach ($category->children as $child)
                                                                            @if ($child->children->isNotEmpty())
                                                                                <li><a class="nav-title"
                                                                                        href="/category/{{ $child['name'] }}">{{ $child['title'] }}</a>
                                                                                </li>
                                                                                <ul>
                                                                                    @foreach ($child->children as $grandChild)
                                                                                        <li><a
                                                                                                href="/category/{{ $child['name'] }}">{{ $grandChild->title }}</a>
                                                                                        </li>
                                                                                    @endforeach
                                                                                </ul>
                                                                                <br />
        ...
        <form class="navbar-search" method="post" action="/search">
            ...
            <div class="input-group">
                @csrf
                <input type="text" id="search" class="form-control search-field" dir="ltr"
                    value="" name="search" placeholder="Search for products" />
