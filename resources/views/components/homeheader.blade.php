                ...
                <div class="container">
                    <nav>
                        <ul id="menu-top-bar-left" class="nav nav-inline pull-left animate-dropdown flip">
                            <li class="menu-item animate-dropdown"><a title="Welcome to {{ ucfirst(request()->get('websiteName')) }} Electronics Store" href="#">Welcome to {{ ucfirst(request()->get('websiteName')) }} Electronics Store</a></li>
                        </ul>
                    </nav>
                        					...
                        					<ul class="cart_list product_list_widget ">
                        						...
                        						<li class="mini_cart_item">
                        							...
                        							<a href="single-product.html">
                        								<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="{{asset('assets/images/products/mini-cart1.jpg')}}" alt="">White lumia 9001&nbsp;
                        							</a>
                        						...
                        						<li class="mini_cart_item">
                        							<a title="Remove this item" class="remove" href="#">×</a>
                        							<a href="single-product.html">
                        								<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="{{asset('assets/images/products/mini-cart2.jpg')}}" alt="">PlayStation 4&nbsp;
                        							</a>
                        						...
                        						<li class="mini_cart_item">
                        							...
                        							<a href="single-product.html">
                        							<img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" src="{{asset('assets/images/products/mini-cart3.jpg')}}" alt="">POV Action Cam HDR-AS100V&nbsp;
                        ...
                        <div class="col-xs-12 col-lg-9">
                            <nav>
                                <ul id="menu-secondary-nav" class="secondary-nav">
                                    ...
                                    <li class="pull-right menu-item"><a href="blog-v2.html">Free Deliveries within Nairobi CBD</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
