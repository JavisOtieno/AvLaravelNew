...
@section('content')
            ...
            <div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb" ><a href="home.html">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>{{ ucfirst($categorySelectedName) }}</nav>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="grid" aria-expanded="true">
                                    ...
                                    <ul class="products columns-3">
                                        ...
                                        <li class="product {{$count % 3 == 1 ? 'first' : ($count % 3 == 2 ? '' : 'last')}}">
                                            ...
                                            <div class="product-outer">
                                                <div class="product-inner">
                                                    <span class="loop-product-categories"><a href="/category/{{$product['category']['name']}}" rel="tag">{{$product['category']['title']}}</a></span>
